...
fun goForIt() {
    ...
    appCompatTheme(name = "MyMainTheme.Red", parent = "MyMainTheme") {
    ...
    appCompatTheme(name = "MyMainTheme.NoActionMode", parent = "MyMainTheme") {
    ...
    appCompatTheme(name = "MyDayNightTheme",
